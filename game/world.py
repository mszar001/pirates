...
class World (context.Context):
    ...
    def __init__ (self, s):
        ...
        island_list = [island.Island,Haunted_Island.Haunted_Island]
        ...
        testland = Haunted_Island.Haunted_Island (self.startx, self.starty+1, self) #Spider_Island.Spider_Island
